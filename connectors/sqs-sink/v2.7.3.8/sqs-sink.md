...
download: "https://api.github.com/repos/streamnative/pulsar-io-sqs/tarball/refs/tags/v2.7.3.8"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-sqs/v2.7.3.8/docs/sqs-sink.png)
...
1. Build a new image based on the Pulsar image with the SQS sink connector and push the new image to your image registry. This example tags the new image as `streamnative/pulsar-sqs:2.7.3.8-rc-3`.
