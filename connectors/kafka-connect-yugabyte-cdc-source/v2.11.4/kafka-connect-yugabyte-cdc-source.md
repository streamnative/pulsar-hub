...
language: Java
document: "https://github.com/yugabyte/debezium-connector-yugabytedb/blob/v2.11.4/README.md"
source: "https://github.com/yugabyte/debezium-connector-yugabytedb/tree/v2.11.4"
...
download: "https://github.com/yugabyte/debezium-connector-yugabytedb/releases/tag/v2.11.4"
support: Community
...
For more information about the properties, see the [offical YugabyteDB CDC Kafka Source Connector documentation](https://github.com/yugabyte/debezium-connector-yugabytedb/blob/v2.11.4/README.md).