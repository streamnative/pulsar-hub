...
language: Java
document: "https://github.com/yugabyte/debezium-connector-yugabytedb/blob/v3.0.6/README.md"
source: "https://github.com/yugabyte/debezium-connector-yugabytedb/tree/v3.0.6"
...
download: "https://github.com/yugabyte/debezium-connector-yugabytedb/releases/tag/v3.0.6"
support: Community
...
For more information about the properties, see the [offical YugabyteDB CDC Kafka Source Connector documentation](https://github.com/yugabyte/debezium-connector-yugabytedb/blob/v3.0.6/README.md).