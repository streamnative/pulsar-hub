...
download: "https://archive.apache.org/dist/pulsar/pulsar-2.4.2/connectors/pulsar-io-debezium-postgres-2.4.2.nar"
...
| `database.history.pulsar.false` | true | null | The name of the database history topic where the connector writes and recovers DDL statements. <br/><br/>**Note: this topic is for internal use only and should not be used by consumers.** |
