...
download: "https://api.github.com/repos/streamnative/pulsar-io-sqs/tarball/refs/tags/v2.10.1.4"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-sqs/v2.10.1.4/docs/sqs-source.png)
...
- Download the NAR package from [here](https://github.com/streamnative/pulsar-io-sqs/releases/download/v2.10.1.4/pulsar-io-sqs-2.10.1.4.nar).
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-sqs-2.10.1.4.nar",
        "parallelism": 1,
        "configs":
        {
...
spec:
  image: streamnative/pulsar-io-sqs:2.10.1.4
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-sqs-2.10.1.4.nar
...
--archive pulsar-io-sqs-2.10.1.4.nar \
...
2. Copy the NAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-sqs-2.10.1.4.nar PULSAR_HOME/connectors/pulsar-io-sqs-2.10.1.4.nar
    ```
