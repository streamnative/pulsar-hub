...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-sqs/v3.0.7.3/docs/sqs-source.png)
...
| `sourceQueueSize`          | int    | false    | 10000              | The size of the queue that holds the messages received from SQS. By default, it is set to 10000. The value cannot smaller than 1.                                                                                                                                                                                                   |
