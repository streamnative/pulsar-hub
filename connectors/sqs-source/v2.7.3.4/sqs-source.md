...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-sqs/v2.7.3.4/docs/sqs-source.png)
...
1. Build a new image based on the Pulsar image with the SQS source connector and push the new image to your image registry. This example tags the new image as `streamnative/pulsar-sqs:2.7.3.4`.
