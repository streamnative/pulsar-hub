...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-bigquery/v2.11.0.5/docs/google-bigquery-sink.png)
...
- Download the JAR package from [the download page](https://github.com/streamnative/pulsar-io-bigquery/releases/download/v2.11.0.5/pulsar-io-bigquery-2.11.0.5.jar).
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-bigquery-2.11.0.5.jar",
...
2. Run the Google Cloud BigQuery sink connector.
    ...
    --archive <pulsar-io-bigquery-2.11.0.5.jar>
    ```
