...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-bigquery/v2.10.2.4/docs/google-bigquery-sink.png)
...
- Download the JAR package from [the download page](https://github.com/streamnative/pulsar-io-bigquery/releases/download/v2.10.2.4/pulsar-io-bigquery-2.10.2.4.jar).
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-bigquery-2.10.2.4.jar",
...
2. Run the Google Cloud BigQuery sink connector.
    ...
    --archive <pulsar-io-bigquery-2.10.2.4.jar>
    ```
