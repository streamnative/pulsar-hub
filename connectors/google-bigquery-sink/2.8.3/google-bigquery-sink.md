...
language: Java
document: 
source: "https://github.com/streamnative/pulsar-io-bigquery/tree/v2.8.3.5/src/main/java/org/apache/pulsar/ecosystem/io/bigquery"
...
download: "https://github.com/streamnative/pulsar-io-bigquery/releases/download/v2.8.3.5/pulsar-io-bigquery-2.8.3.5.jar"
...
- Download the JAR package from [the download page](https://github.com/streamnative/pulsar-io-bigquery/releases/download/v2.8.3.5/pulsar-io-bigquery-2.8.3.5.jar).
...
2. Build the connector in the `pulsar-io-bigquery` directory.
   ...
   ```bash
   ls target
   pulsar-io-bigquery-2.8.3.5.jar
   ```
