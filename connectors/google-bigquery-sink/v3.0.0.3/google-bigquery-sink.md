...
download: "https://api.github.com/repos/streamnative/pulsar-io-bigquery/tarball/refs/tags/v3.0.0.3"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-bigquery/v3.0.0.3/docs/google-bigquery-sink.png)
...
- Download the JAR package from [the download page](https://github.com/streamnative/pulsar-io-bigquery/releases/download/v3.0.0.3/pulsar-io-bigquery-3.0.0.3.jar).
...
2. Build the connector in the `pulsar-io-bigquery` directory.
   ...
   ```bash
   ls target
   pulsar-io-bigquery-3.0.0.3.jar
   ```
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-bigquery-3.0.0.3.jar",
...
spec:
  image: streamnative/pulsar-io-bigquery:3.0.0.3
  className: org.apache.pulsar.ecosystem.io.bigquery.BigQuerySink
  replicas: 1
  maxReplicas: 1
  input:
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-bigquery-3.0.0.3.jar
...
2. Run the Google Cloud BigQuery sink connector.
    ...
    --archive <pulsar-io-bigquery-3.0.0.3.jar>
    ```
