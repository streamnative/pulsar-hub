---
description: The Snowflake sink connector pulls data from Pulsar topics and persists data to Snowflake.
author: ["StreamNative"]
contributors: ["StreamNative"]
language: Java
document:
source: "https://github.com/streamnative/pulsar-io-snowflake/tree/branch-2.9.4.1/src/main/java/org/apache/pulsar/ecosystem/io/snowflake"
...
- Download the NAR package
  from [the download page](https://github.com/streamnative/pulsar-io-snowflake/releases/download/v{{connector:version}}/pulsar-io-snowflake-{{connector:version}}.nar)
  .
...
1. Copy the NAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-snowflake-{{connector:version}}.nar PULSAR_HOME/connectors/pulsar-io-snowflake-{{connector:version}}.nar
    ```
