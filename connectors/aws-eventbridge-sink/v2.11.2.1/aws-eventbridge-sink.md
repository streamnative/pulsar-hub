...
download: "https://api.github.com/repos/streamnative/pulsar-io-aws-eventbridge/tarball/refs/tags/v2.11.2.1"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-aws-eventbridge/v2.11.2.1/docs/aws-eventbridge-sink.png)
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-aws-eventbridge-2.11.2.1.nar",
        "tenant": "public",
        "namespace": "default",
        "inputs": [
...
spec:
  image: streamnative/pulsar-io-aws-eventbridge:2.11.2.1
  replicas: 1
  maxReplicas: 1
  input:
    topics:
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-aws-eventbridge-2.11.2.1.jar
...
2. Run the AWS EventBridge sink connector.
    ...
    --archive <pulsar-io-aws-eventbridge-2.11.2.1.nar>
    ```
