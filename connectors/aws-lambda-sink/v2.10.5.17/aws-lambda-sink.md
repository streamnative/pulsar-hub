...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-aws-lambda/v2.10.5.17/docs/lambda-sink.png)
...
- Download the NAR package from [the download page](https://github.com/streamnative/pulsar-io-aws-lambda/releases/download/v2.10.5.17/pulsar-io-google-pubsub-2.10.5.17.nar).
...
2. Build the connector in the `pulsar-io-aws-lambda` directory.
     ...
     ```bash
     ls target
     pulsar-io-aws-lambda-2.10.5.17.nar
     ```
  ...
  ```json
    {
      ...
      "archive": "connectors/pulsar-io-aws-lambda-2.10.5.17.nar",
      "parallelism": 1,
      "configs":
      {
...
2. Copy the NAR package of the AWS Lambda connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-aws-lambda-2.10.5.17.nar 
    PULSAR_HOME/connectors/pulsar-io-aws-lambda-2.10.5.17.nar
    ```
