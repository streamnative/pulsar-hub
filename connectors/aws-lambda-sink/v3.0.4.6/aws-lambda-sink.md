...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-aws-lambda/v3.0.4.6/docs/lambda-sink.png)
...
- Download the NAR package from [the download page](https://github.com/streamnative/pulsar-io-aws-lambda/releases/download/v3.0.4.6/pulsar-io-google-pubsub-3.0.4.6.nar).
...
2. Build the connector in the `pulsar-io-aws-lambda` directory.
     ...
     ```bash
     ls target
     pulsar-io-aws-lambda-3.0.4.6.nar
     ```
  ...
  ```json
    {
      ...
      "archive": "connectors/pulsar-io-aws-lambda-3.0.4.6.nar",
      "parallelism": 1,
      "configs":
      {
...
spec:
  image: streamnative/pulsar-io-aws-lambda:3.0.4.6
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-aws-lambda-3.0.4.6.nar
...
--archive pulsar-io-aws-lambda-3.0.4.6.nar \
...
2. Copy the NAR package of the AWS Lambda connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-aws-lambda-3.0.4.6.nar 
    PULSAR_HOME/connectors/pulsar-io-aws-lambda-3.0.4.6.nar
    ```
