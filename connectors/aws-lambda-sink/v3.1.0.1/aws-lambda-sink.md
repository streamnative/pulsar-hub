...
download: "https://api.github.com/repos/streamnative/pulsar-io-aws-lambda/tarball/refs/tags/v3.1.0.1"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-aws-lambda/v3.1.0.1/docs/lambda-sink.png)
...
- Download the NAR package from [the download page](https://github.com/streamnative/pulsar-io-aws-lambda/releases/download/v3.1.0.1/pulsar-io-google-pubsub-3.1.0.1.nar).
...
2. Build the connector in the `pulsar-io-aws-lambda` directory.
     ...
     ```bash
     ls target
     pulsar-io-aws-lambda-3.1.0.1.nar
     ```
  ...
  ```json
    {
      ...
      "archive": "connectors/pulsar-io-aws-lambda-3.1.0.1.nar",
      "parallelism": 1,
      "configs":
      {
...
spec:
  image: streamnative/pulsar-io-aws-lambda:3.1.0.1
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-aws-lambda-3.1.0.1.nar
...
--archive pulsar-io-aws-lambda-3.1.0.1.nar \
...
2. Copy the NAR package of the AWS Lambda connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-aws-lambda-3.1.0.1.nar 
    PULSAR_HOME/connectors/pulsar-io-aws-lambda-3.1.0.1.nar
    ```
