...
language: Java
document: 
source: "https://github.com/streamnative/pulsar-io-lakehouse/tree/v2.8.3.5/src/main/java/org/apache/pulsar/ecosystem/io/lakehouse"
...
![](/images/connectors/lakehouse-sink.png)
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-hudi-2.8.3.5.nar",
        "parallelism": 1,
        "configs":   {
            "type": "hudi",
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-hudi-2.8.3.5-cloud.nar",
        "parallelism": 1,
        "configs":   {
            "type": "hudi",
            "hoodie.table.name": "hudi-connector-test",
...
- The Iceberg table that is stored in cloud storage (AWS S3, GCS, or Azure)
    ...
    ```json
    {
        ...
        "archive": "connectors/pulsar-io-lakehouse-2.8.3.5-cloud.nar",
        "processingGuarantees":"EFFECTIVELY_ONCE",
        "configs":{
            "type":"iceberg",
            "maxCommitInterval":120,
...
1. Copy the NAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-lakehouse-2.8.3.5.nar 
    PULSAR_HOME/connectors/pulsar-io-lakehouse-2.8.3.5.nar
    ```
