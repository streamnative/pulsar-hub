...
language: Java
document: 
source: "https://github.com/streamnative/pulsar-io-google-pubsub/tree/v2.8.2.0/src/main/java/org/apache/pulsar/ecosystem/io/pubsub"
...
download: "https://github.com/streamnative/pulsar-io-google-pubsub/releases/download/v2.8.2.0/pulsar-io-google-pubsub-2.8.2.0.nar"
...
- Download the NAR package from [the download page](https://github.com/streamnative/pulsar-io-google-pubsub/releases/download/v2.8.2.0/pulsar-io-google-pubsub-2.8.2.0.nar).
...
To build the Google Cloud Pub/Sub sink connector from the source code, follow these steps.
  ...
  2. Build the connector in the `pulsar-io-google-pubsub` directory.
     ...
     ```bash
     ls target
     pulsar-io-google-pubsub-2.8.2.0.nar
     ```
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-google-pubsub-2.8.2.0.nar",
        "parallelism": 1,
        "configs": {
...
spec:
  image: streamnative/pulsar-io-google-pubsub:2.8.2.0
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-google-pubsub-2.8.2.0.nar
...
2. Copy the NAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-google-pubsub-2.8.2.0.nar PULSAR_HOME/connectors/pulsar-io-google-pubsub-2.8.2.0.nar
    ```
