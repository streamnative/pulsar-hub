...
download: "https://api.github.com/repos/streamnative/pulsar-io-bigquery/tarball/refs/tags/v2.11.2.10"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-bigquery/v2.11.2.10/docs/google-bigquery-source.png)
...
2. Build the connector in the `pulsar-io-bigquery` directory.
   ...
   ```bash
   ls target
   pulsar-io-bigquery-2.11.2.10.jar
   ```
...
You can define a CRD file (YAML) to set the properties as below.
   ...
   spec:
      image: streamnative/pulsar-io-bigquery:2.11.2.10
      ...
      resources:
         ...
         requests:
            ...
            memory: 1G
      java:
         jar: connectors/pulsar-io-bigquery-2.11.2.10.jar
      clusterName: pulsar
   ---
   apiVersion: v1
   kind: ConfigMap
...
2. Copy the JAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-google-bigquery-2.11.2.10.jar PULSAR_HOME/connectors/pulsar-io-google-bigquery-2.11.2.10.jar
    ```
