---
description: The Google Cloud BigQuery source connector feeds data from Google Cloud BigQuery tables and writes data to Pulsar topics.
author: ["StreamNative"]
contributors: ["StreamNative"]
language: Java
document:
source: "https://github.com/streamnative/pulsar-io-bigquery/tree/v2.10.1.10/src/main/java/org/apache/pulsar/ecosystem/io/bigquery"
license: Apache License 2.0
tags: ["Pulsar IO", "BigQuery", "Source"]
...
![](/images/connectors/google-bigquery-source.png)
