...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-bigquery/v2.11.0.2/docs/google-bigquery-source.png)
...
2. Copy the JAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-google-bigquery-2.11.0.2.jar PULSAR_HOME/connectors/pulsar-io-google-bigquery-2.11.0.2.jar
    ```
