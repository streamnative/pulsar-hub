...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-bigquery/v3.0.0.1/docs/google-bigquery-source.png)
...
2. Copy the JAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-google-bigquery-3.0.0.1.jar PULSAR_HOME/connectors/pulsar-io-google-bigquery-3.0.0.1.jar
    ```
