...
contributors: ["Zilliz"]
language: Java
document: "https://github.com/zilliztech/kafka-connect-milvus/blob/v3.0.6/README_OSS.md"
source: "https://github.com/zilliztech/kafka-connect-milvus/tree/v3.0.6"
...
download: "https://github.com/zilliztech/kafka-connect-milvus/releases/tag/v3.0.6"
support: Community
...
For more information about the configuration properties, see the [offical Milvus Kafka Connect Sink Connector documentation](https://github.com/zilliztech/kafka-connect-milvus/blob/v3.0.6/README_OSS.md).
