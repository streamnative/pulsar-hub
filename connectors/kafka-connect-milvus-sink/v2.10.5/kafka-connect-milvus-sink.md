...
contributors: ["Zilliz"]
language: Java
document: "https://github.com/zilliztech/kafka-connect-milvus/blob/v2.10.5/README_OSS.md"
source: "https://github.com/zilliztech/kafka-connect-milvus/tree/v2.10.5"
...
download: "https://github.com/zilliztech/kafka-connect-milvus/releases/tag/v2.10.5"
support: Community
...
For more information about the configuration properties, see the [offical Milvus Kafka Connect Sink Connector documentation](https://github.com/zilliztech/kafka-connect-milvus/blob/v2.10.5/README_OSS.md).
