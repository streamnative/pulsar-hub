...
download: "https://api.github.com/repos/streamnative/pulsar-io-amqp-1-0/tarball/refs/tags/v2.9.5.1"
...
![](https://raw.githubusercontent.com/streamnative/pulsar-io-amqp-1-0/v2.9.5.1/docs/amqp-1-0-source.png)
...
- Download the NAR package from [here](https://github.com/streamnative/pulsar-io-amqp-1-0/releases/download/v2.9.5.1/pulsar-io-amqp1_0-2.9.5.1.nar).
...
* JSON 
    ...
    ```json
    {
        ...
        "archive": "connectors/pulsar-io-amqp1_0-2.9.5.1.nar",
        "parallelism": 1,
        "configs": {
            "protocol": "amqp",
            "host": "localhost",
...
spec:
  image: streamnative/pulsar-io-amqp-1-0:2.9.5.1
  ...
  resources:
    ...
    memory: 1G
  java:
    jar: connectors/pulsar-io-amqp1_0-2.9.5.1.nar
...
--name amqp1_0-source \
--archive pulsar-io-amqp1_0-2.9.5.1.nar \
--classname org.apache.pulsar.ecosystem.io.amqp.AmqpSource \
...
2. Copy the NAR package of the AMQP1_0 source connector to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-amqp1_0-2.9.5.1.nar $PULSAR_HOME/connectors/pulsar-io-amqp1_0-2.9.5.1.nar
    ```
...
3. Start Pulsar in standalone mode.
    ...
    **Output**
    ...
    Found connector ConnectorDefinition(name=amqp1_0, description=AMQP1_0 source and AMQP1_0 connector, sourceClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSource, sinkClass=org.apache.pulsar.ecosystem.io.amqp.AmqpSink, sourceConfigClass=null, sinkConfigClass=null) from /Volumes/other/apache-pulsar-2.8.0-SNAPSHOT/./connectors/pulsar-io-amqp1_0-2.9.5.1.nar
