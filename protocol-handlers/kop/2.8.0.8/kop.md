...
license_link: "https://github.com/streamnative/kop/blob/v2.8.0.8/LICENSE"
...
download: "https://api.github.com/repos/streamnative/kop/tarball/refs/tags/v2.8.0.8"
...
- [Configure KoP](https://github.com/streamnative/kop/blob/v2.8.0.8/docs/configuration.md)
- [Secure KoP](https://github.com/streamnative/kop/blob/v2.8.0.8/docs/security.md)
- [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/v2.8.0.8/docs/envoy-proxy.md)
- [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/v2.8.0.8/docs/implementation.md)
