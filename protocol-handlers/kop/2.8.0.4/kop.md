...
license_link: "https://github.com/streamnative/kop/blob/v2.8.0.4/LICENSE"
...
download: "https://api.github.com/repos/streamnative/kop/tarball/refs/tags/v2.8.0.4"
...
- [Configure KoP](https://github.com/streamnative/kop/blob/v2.8.0.4/docs/configuration.md)
- [Secure KoP](https://github.com/streamnative/kop/blob/v2.8.0.4/docs/security.md)
- [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/v2.8.0.4/docs/envoy-proxy.md)
- [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/v2.8.0.4/docs/implementation.md)
