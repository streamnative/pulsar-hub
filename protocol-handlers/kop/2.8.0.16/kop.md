...
license_link: "https://github.com/streamnative/kop/blob/v2.8.0.16/LICENSE"
...
- [Configure KoP](https://github.com/streamnative/kop/blob/v2.8.0.16/docs/configuration.md)
- [Secure KoP](https://github.com/streamnative/kop/blob/v2.8.0.16/docs/security.md)
- [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/v2.8.0.16/docs/envoy-proxy.md)
- [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/v2.8.0.16/docs/implementation.md)
