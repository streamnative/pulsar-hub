...
license_link: "https://github.com/streamnative/kop/blob/v2.8.0.14/LICENSE"
...
download: "https://api.github.com/repos/streamnative/kop/tarball/refs/tags/v2.8.0.14"
...
- [Configure KoP](https://github.com/streamnative/kop/blob/v2.8.0.14/docs/configuration.md)
- [Secure KoP](https://github.com/streamnative/kop/blob/v2.8.0.14/docs/security.md)
- [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/v2.8.0.14/docs/envoy-proxy.md)
- [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/v2.8.0.14/docs/implementation.md)
